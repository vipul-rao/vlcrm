    ...
    <div class="container">
        <div class="row bloglist_margin_block bloglist_margintop">
            ...
            <div class="col-sm-5 col-md-5 col-xl-5 col-lg-5 ml-auto col-12">
                <h3 class="mb-4 mt-5">Get In Touch</h3>
                <p class="contact_get"><span class="blockquote_color">If you are interested in working with us, please get in touch.</span></p>
                <p class="contact_get">Address: <span class="contact1_span"><b>{{$settings['address']??''}}</b></span><br />
                    Phone: <span class="contact1_span"><b>{{$settings['phone_number']??''}}</b></span><br />
                    Email: <span class="text_primary">{{$settings['site_email']??''}}</span><br /></p>
                <p> Monday to Friday from <span class="contact1_span"><b>9.00 am to 8.00 pm EST</b></span><br />
                    Saturday from <span class="contact1_span"><b>10.00 am to 6.00 pm EST</b></span></p>
            </div>
        </div>
    </div>
